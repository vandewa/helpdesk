...
<body class="img js-fullheight"
    style="background-image:url(https://img.freepik.com/free-photo/corridor-unfocused_1203-1210.jpg?w=1800&t=st=1698208055~exp=1698208655~hmac=97eb905722262643f0b9c5c7184e04091268edd518e2214d9cd6c9144225f09e);object-fit:cover">
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="mt-4 mb-0 text-center col-md-6">
                    <img src="https://www.mitraintibersama.com/assets/img/logo-mib.png" style="width: 300px;">
                    {{-- <h2 class="heading-section">
                        <span
                            style="margin-left: 10px; font-weight: bold; font-family: 'Teko', sans-serif; color: #ffffff; font-size: 40pt">VERVAL
                            ATS</span>
                    </h2>
                    <span
                        style="margin-left: 10px; font-weight: normal; font-family: 'Teko', sans-serif; color: #ffffff; font-size: 20pt">(
                        Verifikasi Validasi Anak Tidak Sekolah )</span> --}}
